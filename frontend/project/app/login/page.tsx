...
// You can keep the icon components in the same file or move them to a separate components folder
const LeafIcon = () => (
  <svg
...
// The main component for the login page, which is the default export
